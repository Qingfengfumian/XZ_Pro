...
from utils import real_warns_5G,mkdir,load_model_infos, save_model_infos, load_from_json,find_new_model_file

def predict_TF_5G(para,pred_ft_data6, ft_cols6,pred_ft_data7, ft_cols7,distr):
    mod_path = r"./Data/{}/Inter_Result/5G/{}_退服_模型/".format(distr, para.ftype)
    ...
    origin_data = pd.read_csv(
            './Data/{}/Alert_Deal/Samp_{}_{}/故障_处理_{}_delJZ_5G.csv'.format(distr, para.mode, para.ftype, date),
    ...
    tf_data = test_data[test_data['告警名称'].isin(real_warns_5G)]
